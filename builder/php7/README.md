...
Once the image has finished building, the command *s2i usage zcloud-php-builder* will print out the help info that was defined in the *usage* script.
...
```
s2i build test/test-app zcloud-php-builder zcloud-php-builder-app
